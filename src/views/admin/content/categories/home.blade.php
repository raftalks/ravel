...
<script type="text/ng-template" id='categories/table'>
  @include('ravel::admin.content.categories.table')
</script>

<script type="text/ng-template" id='categories/create'>
 @include('ravel::admin.content.categories.create')
</script>

<script type="text/ng-template" id='categories/edit'>
 @include('ravel::admin.content.categories.edit')
</script>

<script type="text/ng-template" id='categories/view'>
 @include('ravel::admin.content.categories.view')
</script>
...
<script type="text/javascript">
	...
	App.factory('DataSource', function($resource){
	  return $resource('<?php echo action("PostsCategoriesApiController@index");?>/:id',
	  		{id:'@id'},
	  		{
				    query: {method:'GET'},
				    get:{method:'GET'},
  ...
  App.directive('paginator',function($timeout)
  {
    ...
    $scope.show_template = 'categories/table';
	...
	//CRUD
		...
		{
        $scope.item = item;
        $scope.gotopage('categories/view');
		}
    ...
    $scope.edit = function(item)
    {
        ...
        $scope.gotopage('categories/edit');
    }
